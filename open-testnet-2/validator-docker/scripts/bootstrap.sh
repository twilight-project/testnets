./nyksd tx nyks set-delegate-addresses $(nyksd keys show validator-self -a --bech val --keyring-backend test) $(nyksd keys show validator-self -a --keyring-backend test) 03b2b1d509b1655b422118a34c1c4b92967287bc4b0e722e168b8d5ce744f71cd8 $(nyksd keys show validator-self -a --keyring-backend test) --from validator-self --chain-id nyks --keyring-backend test
./nyksd tx bridge register-judge $(nyksd keys show validator-self -a --keyring-backend test) $(nyksd keys show validator-self --bech val -a --keyring-backend test) --from validator-self --chain-id nyks --keyring-backend test
./nyksd tx bridge bootstrap-fragment $(nyksd keys show validator-self -a --keyring-backend test) 6 5 1 1 22 --from validator-self --chain-id nyks --keyring-backend test
...
./nyksd tx bank send $(nyksd keys show validator-self -a --keyring-backend test) $(nyksd keys show signer1 -a --keyring-backend test) 1000nyks --keyring-backend test
./nyksd tx bank send $(nyksd keys show validator-self -a --keyring-backend test) $(nyksd keys show signer2 -a --keyring-backend test) 1000nyks --keyring-backend test
./nyksd tx bank send $(nyksd keys show validator-self -a --keyring-backend test) $(nyksd keys show signer3 -a --keyring-backend test) 1000nyks --keyring-backend test
./nyksd tx bank send $(nyksd keys show validator-self -a --keyring-backend test) $(nyksd keys show signer4 -a --keyring-backend test) 1000nyks --keyring-backend test
./nyksd tx bank send $(nyksd keys show validator-self -a --keyring-backend test) $(nyksd keys show signer5 -a --keyring-backend test) 1000nyks --keyring-backend test
./nyksd tx bank send $(nyksd keys show validator-self -a --keyring-backend test) $(nyksd keys show signer6 -a --keyring-backend test) 1000nyks --keyring-backend test
...
./nyksd tx bridge register-reserve-address 1 14uEN8abvKA1zgYCpv8MWCUwAMLGBqdZGM 14uEN8abvKA1zgYCpv8MWCUwAMLGBqdZGM --from validator-self --chain-id nyks --keyring-backend test

./nyksd keys add faucet --keyring-backend test
./nyksd tx bank send $(nyksd keys show validator-self -a --keyring-backend test) $(nyksd keys show faucet -a --keyring-backend test) 1000000000nyks --keyring-backend test
./nyksd tx bridge register-deposit-address 1BY1odPsGFFhQZCcc7M6V4w2v4kaVHFTgp 100000000000000 1000 --from faucet --chain-id nyks --keyring-backend test
